!
  function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && (define.amd || defined.cmd) ? define([], t) : "object" == typeof exports ? exports.vueWaterfallEasy = t() : e.vueWaterfallEasy = t()
    ...
    return function (e) {
      ...
      e.exports = function (e, t, n, i, a, r) {
        var s, o = e = e || {},
          l = typeof e.
            default;
        "object" !== l && "function" !== l || (s = e, o = e.
          default);
        var d = "function" == typeof o ? o.options :
          o;
      ...
      t.a = {
        ...
        mounted: function () {
          ...
          }), this.isMobile || this.width || window.addEventListener("resize", this.response), this.isMobile && this.enablePullDownEvent && this.pullDown(), this.scroll()
        },
        ...
        methods: {
          ...
          response: function () {
            var e = this.cols;
            this.cols = this.calcuCols(), e !== this.cols && (this.beginIndex = 0, this.waterfall(), this.over && this.setOverTipPos())
          },
          scrollFn: function () {
      ...
      d.options.__file = "src\\vue-waterfall-easy\\vue-waterfall-easy.vue", t.
        default = d.exports
    }, function (e, t, n) {
      var i = n(7);
      "string" == typeof i && (i = [
